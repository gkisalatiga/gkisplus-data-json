...
class ScraperPdfLiturgi(Scraper):

    SCRAPE_URL_LIST = [
        'https://gkisalatiga.org/category/tata-ibadah',
        'https://gkisalatiga.org/category/tata-ibadah/page/2',
    ]
    ...
    def run(self):
        ...
        self.json_data['data']['pdf']['liturgi'] = []
        ...
        for i in range(len(s1)):
            ...
            self.json_data['data']['pdf']['liturgi'].append({
                'title': s2[i],
        ...
        # Write changes.
        super().write(write_msg='pdf/liturgi')
